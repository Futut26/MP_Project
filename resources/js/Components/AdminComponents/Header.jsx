...
const Header = ({ auth, toggleSidebar, isSidebarOpen }) => {
  ...
  return (
    <header className="bg-white shadow-md h-auto w-full flex justify-between items-center sticky top-0 z-50 px-10">
      <div className="w-auto flex h-16 md:h-20 gap-2">
        <button onClick={toggleSidebar} className="text-3xl md:hidden block">
